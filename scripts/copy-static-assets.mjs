...
await copyFile("assets/favicon-192.png", "dist/client/assets/favicon-192.png");
await copyFile("assets/favicon-512.png", "dist/client/assets/favicon-512.png");
await copyFile("assets/headshot-placeholder.svg", "dist/client/assets/headshot-placeholder.svg");
await copyFile("assets/headshot.jpg", "dist/client/assets/headshot.jpg");
